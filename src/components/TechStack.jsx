...
const stack = [
  {
    category: 'Languages',
    items: ['Rust', 'Go', 'JavaScript', 'Kotlin', 'C++'],
  },
  {
    category: 'Backend',
    items: ['Node.js', 'Chi'],
  ...
  },
  {
    ...
    items: ['Git', 'GitHub', 'Vercel', 'Railway', 'Termux', 'Linux', 'CMake'],
  },
];

function AnimatedGroup({ category, items, index }) {
...
export function TechStack() {
  ...
  return (
    <section className="py-24 md:py-32" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
      <div className="max-w-5xl mx-auto px-6 md:px-10">
        ...
        <div style={{
          ...
          {stack.map((group, i) => (
            <AnimatedGroup key={group.category} category={group.category} items={group.items} index={i} />
          ))}
        </div>
      </div>
    </section>
