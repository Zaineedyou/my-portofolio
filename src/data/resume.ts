// Content sourced verbatim from the original resume.tsx data file.
// Do not paraphrase, trim, or reorder any text values here — only the
// surrounding visual components may change.
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "A production-ready Go Discord bot powered by Groq AI, combining multi-model chat and image analysis with conversational memory, moderation, leveling, AFK, welcome, and server administration tools.",
      technologies: ["Go", "Discord", "Groq API"],
      links: [{ type: "Source", href: "https://github.com/Zaineedyou/CaineGO" }],
      image: "/CaineGO.png",
      video: "",
    },
    {
      ...
      active: true,
      description:
        "A self-hosted Rust web application for custom Discord Rich Presence through Gateway v10, with an Axum/Tokio backend, live browser preview, profile persistence, image hosting, REST APIs, and automatic reconnects.",
      technologies: ["Rust", "Discord RPC", "WebUI"],
      links: [{ type: "Source", href: "https://github.com/Zaineedyou/ClaudiaRPC-Rust" }],
      image: "/RpcRust.png",
      video: "",
    },
    {
      ...
      active: true,
      description:
        "A low-level Discord bot built primarily in x86-64 assembly, with C adapters for secure transport, Discord Gateway and REST integration, Groq AI, moderation, attachments, vision payloads, persistence, and vector-tested subsystems.",
      technologies: ["x86-64 Assembly", "C", "Discord", "Groq AI"],
      links: [{ type: "Source", href: "https://github.com/Zaineedyou/CaineASM" }],
      image: "",
      video: "",
    },
    {
      ...
      active: true,
      description:
        "A mobile-first CRT/VHS post-processing shaderpack for Iris, combining letterbox framing, tube curvature, analog signal instability, phosphor persistence, and a low-end-friendly Potato Mode without compute shaders.",
      technologies: ["GLSL", "Iris", "Minecraft", "Mobile Graphics"],
      links: [{ type: "Source", href: "https://github.com/Zaineedyou/Valtique" }],
      image: "",
      video: "",
    },
    {
      ...
      active: true,
      description:
        "A client-side Fabric optimization foundation for constrained devices: persistent low-allocation chunk caching, bounded background work, batched I/O, memory-aware data paths, and an FPS-aware cache governor.",
      technologies: ["Java", "Fabric", "Minecraft", "Performance"],
      links: [{ type: "Source", href: "https://github.com/Zaineedyou/Val0x2F" }],
      image: "",
      video: "",
    },
    {
      ...
      active: true,
      description:
        "A client-side Fabric addon for Simple Voice Chat that applies reusable PCM effects to outgoing microphone audio through the official API, with War Radio, Female Voice, and customizable low-CPU DSP presets.",
      technologies: ["Java", "Fabric", "Audio DSP", "Minecraft"],
      links: [{ type: "Source", href: "https://github.com/Zaineedyou/val0x07" }],
      image: "",
      video: "",
    },
    {
